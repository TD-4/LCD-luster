...
def parse_arguments():
    ...
    parser.add_argument('-i', '--images', default=r'F:\Data\lcd\midle\midle', type=str, help='Path to the vallist.txt')
    parser.add_argument('-o', '--outputs', default=r'F:\middle', type=str, help='Output Path')
    parser.add_argument('-oc', '--outputs_ok', default=r'F:\middle_cam', type=str, help='Output Path')
