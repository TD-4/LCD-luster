...
class EdgeDataLoader(BaseDataLoader):
    def __init__(self, data_dir,
        ...
        if in_channels == 3:
            ...
            self.MEAN = [0.3872299906769029]  # [0.3858034032292721] BDD; [0.6790830900388274]BDD histogram之后;[3872299906769029]
            self.STD = [0.1303032466553607]  # [0.12712721340420535];[25241563832076486];[0.1303032466553607]
        kwargs = {
            'root': data_dir,
        ...
        self.dataset = EdgeDataset(**kwargs)
        super(EdgeDataLoader, self).__init__(self.dataset, batch_size, shuffle, num_workers)
